...
class Detector():
    ...
    def __init__(self, window_name=r'Mirror'):
        ...
        * window_name: Name of the window to capture
        ...
        self.items_on_board = {
                               1: (1, 'STR','./data/items/star.png'),   # ID: 1
                               2: (2, 'ORB','./data/items/orb.png'),    # ID: 2
                               3: (3, 'PTN','./data/items/potion.png'), # ID: 3
                               4: (4, 'SWD','./data/items/sword.png'),  # ID: 4
                               5: (5, 'DMD','./data/items/diamond.png') # ID: 5
                              }
    ...
    def capture_screen(self, frames):
        """
        capture n frames, if frames < 0, loop is infinte
        """
        while frames != 0:
            frames -= 1
            ##########################################################
            ...
            ##########################################################
            game_frame = self.detect_window()
            ################ Getting board dimensions ###############
            game_board_frame = self.get_board_window(game_frame)
            ################ Getting turns dimensions ###############
            game_turns_frame = self.get_turns_window(game_frame)
            #########################################################
            ###################### Reflexia View ####################
            #########################################################
